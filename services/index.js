...
// Update diet plan
app.put("/diet-plans/:id", async (req, res) => {
  try {
...
// Delete diet plan
app.delete("/diet-plans/:id", async (req, res) => {
  try {
...
app.get("/progress", async (req, res) => {
  try {
    const progress = await Progress.find().sort({
      createdAt: -1,
    });
